...
KV = """
Screen: # Screen è il widget di primo livello (widget root)
...
class MainApp(MDApp): # estendo MDApp
    def build(self): # ridefinisco build di MDApp
...
# title con Hello Kivy e requirements aggiungendo kivymd ai già 
# presenti python3,kivy
# per creare il file buildozer.spec in cui inserire alcune proprietà dell'app
